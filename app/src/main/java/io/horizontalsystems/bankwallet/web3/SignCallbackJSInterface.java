...
import io.horizontalsystems.bankwallet.core.utils.Hex;
import io.horizontalsystems.bankwallet.core.utils.MessageUtils;
import io.horizontalsystems.bankwallet.core.utils.Util;
...
import io.horizontalsystems.bankwallet.web3j.StructuredDataEncoder;
...
public class SignCallbackJSInterface {
    ...
    private String getDomainName() {
        return webView == null ? "" : Util.getDomainName(webView.getUrl());
    }
}
