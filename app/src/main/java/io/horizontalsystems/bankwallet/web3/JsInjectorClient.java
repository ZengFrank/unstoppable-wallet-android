...
public class JsInjectorClient {
    ...
    private String rpcUrl = "https://mainnet.infura.io/v3/bbfb2fa1009e40e4b72b10166d9a5069"; //EthereumNetworkRepository.getDefaultNodeURL(EthereumNetworkBase.MAINNET_ID);
    ...
    String injectWeb3TokenInit(Context ctx, String view, String tokenContent, BigInteger tokenId)
    {
        ...
        initSrc = String.format(initSrc, tokenContent, walletAddress,rpcUrl /*EthereumNetworkRepository.getDefaultNodeURL(chainId)*/, chainId, tokenIdWrapperName);
